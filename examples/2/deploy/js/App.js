...
var Main = $hxClasses["Main"] = function() {
	this.playerClassArguments = [];
	this.enemyClassArguments = [];
...
Main.prototype = {
	...
	,initializeToGameScene: function() {
		this.player = Type.createInstance(this.playerClass,this.playerClassArguments);
		this.enemy = Type.createInstance(this.enemyClass,this.enemyClassArguments);
	...
	,enemy: null
	,enemyClassArguments: null
	,enemyClass: null
	,player: null
	,playerClassArguments: null
	,playerClass: null
	,mainFunction: null
	,__class__: Main
}
...
MainForJS.prototype = $extend(Main.prototype,{
	runForGameScene: function() {
		Main.prototype.runForGameScene.call(this);
		this.stage.update();
	}
	,initializeToGameScene: function() {
		this.playerClass = shooting.player.PlayerForJS;
		this.playerClassArguments.push(this.stage);
		this.enemyClass = shooting.enemy.EnemyForJS;
		this.enemyClassArguments.push(this.stage);
		Main.prototype.initializeToGameScene.call(this);
	}
	,stage: null
	,__class__: MainForJS
});
...
var PreloaderForJS = $hxClasses["PreloaderForJS"] = function() {
	js.Lib.window.onload = $bind(this,this.initialize);
	Preloader.call(this);
};
PreloaderForJS.__name__ = ["PreloaderForJS"];
PreloaderForJS.main = function() {
	new PreloaderForJS();
}
PreloaderForJS.__super__ = Preloader;
PreloaderForJS.prototype = $extend(Preloader.prototype,{
	initializeMain: function() {
		Preloader.prototype.initializeMain.call(this);
		new MainForJS();
	}
	,load: function() {
		this.loader.run();
...
shooting.enemy.Enemy = $hxClasses["shooting.enemy.Enemy"] = function() {
...
shooting.enemy.EnemyForJS = $hxClasses["shooting.enemy.EnemyForJS"] = function(layer) {
	shooting.enemy.Enemy.call(this);
	layer.addChild(this.view);
};
shooting.enemy.EnemyForJS.__name__ = ["shooting","enemy","EnemyForJS"];
shooting.enemy.EnemyForJS.__super__ = shooting.enemy.Enemy;
shooting.enemy.EnemyForJS.prototype = $extend(shooting.enemy.Enemy.prototype,{
	__class__: shooting.enemy.EnemyForJS
});
...
shooting.player.PlayerForJS.prototype = $extend(shooting.player.Player.prototype,{
	hitareaBounds: null
	,__class__: shooting.player.PlayerForJS
});
var $_;
