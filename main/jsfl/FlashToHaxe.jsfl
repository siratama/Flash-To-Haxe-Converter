...
tmpl.as3.Bitmap.create = function(packageStr,className) {
	var fileLines = tmpl.as3.Bitmap.template.execute({ packageStr : packageStr, className : className});
	return fileLines;
}
...
tmpl.as3.Sound.__name__ = true;
tmpl.as3.Sound.create = function(packageStr,className) {
	var fileLines = tmpl.as3.Sound.template.execute({ packageStr : packageStr, className : className});
	return fileLines;
}
if(!tmpl.haxe) tmpl.haxe = {}
tmpl.haxe.Bitmap = function() { }
tmpl.haxe.Bitmap.__name__ = true;
tmpl.haxe.Bitmap.create = function(packageStr,className,$namespace,nativeClassName) {
	var fileLines = tmpl.haxe.Bitmap.template.execute({ 'namespace' : $namespace, nativeClassName : nativeClassName, packageStr : packageStr, className : className});
	return fileLines;
}
