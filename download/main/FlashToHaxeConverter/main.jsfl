...
jsfl.EnterEditMode.__name__ = ["jsfl","EnterEditMode"];
jsfl.AddDataToDocumentType = function() { }
jsfl.AddDataToDocumentType.__name__ = ["jsfl","AddDataToDocumentType"];
...
jsfl.AddDataToDocumentType.INTEGER = "integer";
jsfl.AddDataToDocumentType.INTEGER_ARRAY = "integerArray";
jsfl.AddDataToDocumentType.DOUBLE = "double";
jsfl.AddDataToDocumentType.DOUBLE_ARRAY = "doubleArray";
jsfl.AddDataToDocumentType.STRING = "string";
jsfl.AddDataToDocumentType.BYTE_ARRAY = "byteArray";
